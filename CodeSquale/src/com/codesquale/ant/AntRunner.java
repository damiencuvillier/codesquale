...
public class AntRunner
{
     ...
     * @exception Exception Exceptions are self-explanatory (read their Message)
     */
    public void setProperties(Map _properties, boolean _overridable) throws Exception
    {
        // Test if the project exists
        if (project == null) throw new Exception("Properties cannot be set" +
    ...
    public boolean runTarget(String _target) throws Exception
    {
        ...
        // Run the target
        try { project.executeTarget(_target); return true; }
        catch (BuildException e)
